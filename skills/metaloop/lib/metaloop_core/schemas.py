...
V2_ENGINEERING_GOVERNANCE_SCHEMA = "metaloop.v2.engineering_governance"
...
V2_GOVERNANCE_REF_ROLES = {"governing_document", "implementation", "migration_plan", "module_contract", "test_contract"}
