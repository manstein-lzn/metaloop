...
旧 Mission Capsule 流程继续作为 v1 兼容入口，并支持可选 engineering governance
refs/hashes。v2 初始化后，v1 mutable commands 必须 fail closed，避免双真相。
...
- governing documents 或 module contracts 漂移时必须显式 revision，不得静默继续。
